...
android {
    ...
    buildTypes {
        debug {
            // Allow cleartext traffic for local dev / staging
        }
        release {
...
dependencies {
    modules {
        module("com.squareup.okhttp3:okhttp-jvm") {
            replacedBy("com.squareup.okhttp3:okhttp-android", "Use Android variant instead of JVM variant")
        }
    }
}
